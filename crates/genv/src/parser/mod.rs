...
lazy_static! {
    static ref STDLIB_FILES: HashMap<String, &'static str> = {
        ...
        m.insert(
            "/std/src/lib.rk".into(),
            include_str!("/react/std/src/lib.rk"),
        );
        m.insert(
            "/std/src/clone.rk".into(),
            include_str!("/react/std/src/clone.rk"),
        );
        m.insert(
            "/std/src/eq.rk".into(),
            include_str!("/react/std/src/eq.rk"),
        );
        m.insert(
            "/std/src/externs.rk".into(),
            include_str!("/react/std/src/externs.rk"),
        );
        m.insert(
            "/std/src/fs.rk".into(),
            include_str!("/react/std/src/fs.rk"),
        );
        m.insert(
            "/std/src/functor.rk".into(),
            include_str!("/react/std/src/functor.rk"),
        );
        m.insert(
            "/std/src/helpers.rk".into(),
            include_str!("/react/std/src/helpers.rk"),
        );
        m.insert(
            "/std/src/num.rk".into(),
            include_str!("/react/std/src/num.rk"),
        );
        m.insert(
            "/std/src/prelude.rk".into(),
            include_str!("/react/std/src/prelude.rk"),
        );
        m.insert(
            "/std/src/print.rk".into(),
            include_str!("/react/std/src/print.rk"),
        );
        m.insert(
            "/std/src/show.rk".into(),
            include_str!("/react/std/src/show.rk"),
        );
        m.insert(
            "/std/src/vec.rk".into(),
            include_str!("/react/std/src/vec.rk"),
        );
        m
    };
}
