...
// }
//
// fn unqualified_name(input: Input) -> PineResult<UnqualifiedName> {
//     map(
...
// }
//
// fn module_path(input: Input) -> PineResult<ModulePath> {
//     context(
//         "module path",
//         token(alt((
...
// }
//
// fn function_definition(input: Input) -> PineResult<FunctionDefinition> {
//     context(
//         "function definition",
//         map(
//             tuple((
...
// }
//
// fn record_definition(input: Input) -> PineResult<RecordDefinition> {
//     context(
//         "record definition",
//         map(
//             tuple((
...
// }
//
// fn record_field_definition(input: Input) -> PineResult<types::RecordField> {
//     context(
//         "record field",
//         map(
...
// }
//
// fn type_alias(input: Input) -> PineResult<TypeAlias> {
//     context(
//         "type alias",
//         map(
...
// }
//
// fn type_(input: Input) -> PineResult<Type> {
...
// }
//
// fn expression(input: Input) -> PineResult<Expression> {
//     context(
//         "expression",
//         map(
//             tuple((
...
// }
//
// fn record(input: Input) -> PineResult<Record> {
...
// }
//
// fn variable(input: Input) -> PineResult<Variable> {
//     context(
//         "variable",
//         map(
//             tuple((position, token(qualified_identifier))),
...
// }
//
// fn qualified_identifier(input: Input) -> PineResult<String> {
//     map(
//         recognize(tuple((
//             raw_identifier,
...
// }
//
// fn identifier(input: Input) -> PineResult<String> {
...
// }
//
// fn keyword(name: &'static str) -> impl FnMut(Input) -> PineResult<()> {
...
// fn position(input: Input) -> PineResult<impl Fn() -> Position + '_> {
//     let (input, _) = blank(input)?;
//
